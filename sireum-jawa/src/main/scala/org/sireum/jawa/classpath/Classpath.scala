...
import org.sireum.jawa.io.{ AbstractFile, Directory, File, Jar }
    ...
    dir foreach {
      f =>
        ...
        val isDirectory = f match {
          case pf: org.sireum.jawa.io.PlainFile => pf.givenPath match {
            case _: org.sireum.jawa.io.Directory => true
            case _: org.sireum.jawa.io.File      => false
